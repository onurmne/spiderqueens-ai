...
export const isSupabaseConfigured = Boolean(url && key && (url.includes("supabase") || url.startsWith("http")));

// Directly create client to prevent build minification crashes (jn is not a function)
